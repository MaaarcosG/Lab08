...
class App extends React.Component {
  ...
  Operations(operacion) {
    ...
    // cambiar signo
    if (operacion == '+/-') {
      const resultado = this.calculosOperaciones(pasarOperacion, vArrayValor[0], parseInt(vInicial));
      vArrayValor = [];
    ...
    return (
      <div>
        <div className="calculator">
          ...
          <div className="keys">
            <button className="style" onClick={this.Operations.bind(this, 'c')}> c </button>
            <button className="style">+/-</button>
            <button className="style" onClick={this.Operations.bind(this, '%')}> % </button>
            <button className="style" onClick={this.Operations.bind(this, '/')}> ÷ </button>
            ...
            <button className="style" onClick={this.Operations.bind(this, '*')}> x </button>
            ...
            <button disabled className="style" onClick={this.añadirValor.bind(this, '.')}>.</button>
            <button className="style" onClick={this.Operations.bind(this, '=')}>=</button>
          </div>
        </div>
      </div>
